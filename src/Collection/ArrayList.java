 ...
 *
 * List: упорядоченная коллекция объектов, которая позволяет дубликаты, null и все элементы имеют индекс;
 ...
 * ArrayList (односвязный список) в Java представляет собой класс, который реализует динамический массив.
