 ...
 *
 * Big O - функция показывающая временную, асимптотическую сложность алгоритма в зависимости от входных данных.
 * Big O показывает сколько будет работать алгоритм в зависимости от количества входных параметров.
 */
public class Linear {
